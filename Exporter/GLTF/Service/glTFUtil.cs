...
namespace ASRR.Revit.Core.Exporter.GLTF.Service
{
    ...
    {
        public static void addVec3BufferViewAndAccessor(Model.GLTF gltf, glTFBinaryData bufferData)
        {
        ...
        public static void addNormalBufferViewAndAccessor(Model.GLTF gltf, glTFBinaryData bufferData)
        {
        ...
        public static void addIndexsBufferViewAndAccessor(Model.GLTF gltf, glTFBinaryData bufferData)
        {
            var byteOffset = 0;
            if (gltf.bufferViews.Count > 0)
            {
        ...
        public static void addUvBufferViewAndAccessor(Model.GLTF gltf, glTFBinaryData bufferData)
        {
