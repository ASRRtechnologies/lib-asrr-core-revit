...
namespace ASRR.Revit.Core.Exporter.GLTF.Model
{
    ...
    public class GlTFExportContext : IExportContext
    {
        ...
        public void OnMaterial(MaterialNode matNode)
        {
            ...
            {
                uniqueId = string.Format("r{0}g{1}b{2}", matNode.Color.Red.ToString(), matNode.Color.Green.ToString(),
                    matNode.Color.Blue.ToString());
                matName = string.Format("MaterialNode_{0}_{1}", Util.ColorToInt(matNode.Color),
